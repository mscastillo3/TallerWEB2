...
describe('MuseumArtworkService', () => {
  ...
  const seedDatabase = async () => {
    void artworkRepository.clear();
    void museumRepository.clear();
  ...
  it('deleteArtworkToMuseum should remove an artwork from a museum', async () => {
    ...
    const deletedArtwork: ArtworkEntity | undefined =
      storedMuseum.artworks.find((a) => a.id === artwork.id);

    expect(deletedArtwork).toBeUndefined();
  });

  it('deleteArtworkToMuseum should thrown a    xception for an invalid artwork', async () => {
    await expect(() =>
